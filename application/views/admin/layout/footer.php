...
?><div id="footer">
	<p class="right"><a href="<?php echo admin_url('dashboard/welcome/it'); ?>">Italiano</a> - <a href="<?php echo admin_url('dashboard/welcome/en'); ?>">English</a> - <?php echo CMS; ?> CMS - v<?php echo MILK_VERSION; ?></p>
