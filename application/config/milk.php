...
/*
 * STRIP WEBSITE URL
 * Se impostato a true, verr� rimosso l'indirizzo del sito da tutti i campi salvati nei records
 * � utile per popolare il sito in sviluppo e portarlo in produzione senza che rimangono i vecchi url
