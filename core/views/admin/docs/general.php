...
<ul>
	<li><strong>core/views/type_templates/{NomeTipo}/detail.php</strong> - utilizzata nel rendering di dettaglio di un singolo contenuto</li>
	<li><strong>core/views/type_templates/{NomeTipo}/list.php</strong> - utilizzata nel rendering di lista di pi&ugrave; contenuti di un singolo tipo.</li>
</ul>
...
<p>Funzione usata internamente dal sistema quando il file di cache non &egrave; presente, provvede a rigenerarlo.</p>
	...
	<div class="sidebar_content" id="sb-languages">
			...
			<p>To add a language, first of all locate the <strong>website_languages</strong> under the <strong>application/config/website.php</strong> config variables, and add a new language as in the example below:</p>
...
<p>For example, the translated labels for the italian language are located here: <strong>application/languages/it_IT</strong>.<br />
